...
//     for (int i = flag+1; i <= numEntries; i++){
...
//     int type = StaticBuffer::getStaticBlockType(intBlockNum)/* block type of a child of any entry of the internalEntries array */;
//     //            (use StaticBuffer::getStaticBlockType())
//     InternalEntry entry;
//     rightBlk.getEntry(&entry, 0);
...
//                 int retVal = bPlusInsert(relId, attrName, record[i], recId); ///doubt...
